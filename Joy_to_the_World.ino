...
All credit is due to the author of an instructable I stumbled upon.
Code taken from: http://www.instructables.com/id/Arduino-Christmas-Light-Controller
Original instructable written by: dany32412 (Twitter: @hankedan000)

Run-as-is with on an Arduino Uno with a 4-channel relay connected to pins
2, 3, 4 and 5. (5V VCC and GND as well, naturally.) Original code was
designed to run an 8 channel relay.
*/
